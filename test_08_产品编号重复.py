...
class Chanpin(Denglu):
    ...
    def test_01chanpin(self):
        ...
        self.huohu.find_element_by_xpath(
            "/html/body/section/section/section/div/div/section/div/form/div[1]/div[1]/input").send_keys("礼券梨")
        time.sleep(2)
        self.huohu.find_element_by_xpath(
            "/html/body/section/section/section/div/div/section/div/form/div[2]/div[1]/input").send_keys("apple4561224")
        time.sleep(2)
        self.huohu.find_element_by_xpath(
        ...
        time.sleep(3)
        try:
            expect = self.huohu.find_element_by_css_selector("#layui-layer1").text
            self.assertEqual(expect, "产品编号有重复!", msg="新增失败")
